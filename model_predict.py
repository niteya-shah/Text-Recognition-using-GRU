...
gru_1 =  tf.keras.layers.Bidirectional(tf.keras.layers.GRU(num_units, return_sequences=True,kernel_initializer='he_normal', name='gru1'))(train_input_val)
gru_2 =  tf.keras.layers.Bidirectional(tf.keras.layers.GRU(num_units, return_sequences=True,kernel_initializer='he_normal', name='gru2'))(gru_1)
gru_3 =  tf.keras.layers.Bidirectional(tf.keras.layers.GRU(num_units, return_sequences=True,kernel_initializer='he_normal', name='gru3'))(gru_2)
